...
export interface SimilarVerseResults {
...
export namespace Convert {
    export function toSimilarVerseResults(json: string): SimilarVerseResults {
        return cast(JSON.parse(json), r('SimilarVerseResults'));
    }

    export function similarVerseResultsToJson(value: SimilarVerseResults): string {
    ...
    const typeMap: any = {
        'SimilarVerseResults': o({
            similarity_id: '',
            url: '',
            reference: '',
            similar_verses: a(r('Verse')),
            verse: r('Verse'),
        }, false),
        'Verse': o({
            verse: '',
