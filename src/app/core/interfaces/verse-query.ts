...
export namespace Convert {
    export function toVerseQuery(json: string): VerseQuery {
        return cast(JSON.parse(json), r('VerseQuery'));
    }

    export function verseQueryToJson(value: VerseQuery): string {
